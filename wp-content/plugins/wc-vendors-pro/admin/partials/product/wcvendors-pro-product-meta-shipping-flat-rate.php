...
<div class="options_group">
	...
	<p class="form-field" style="display: block;">
		...
		<?php $checked ?>
		<input type="checkbox" class="checkbox" style="" name="_shipping_fee_national_qty" id="_shipping_fee_national_qty" <?php checked( 'yes', $shipping_details[ 'national_qty_override' ], true ); ?> />
	...
	<p class="form-field" style="display: block;">
		...
		<input type="checkbox" class="checkbox" style="" name="_shipping_fee_national_free" id="_shipping_fee_national_free"  <?php checked( 'yes', $shipping_details[ 'national_free' ], true ); ?> />
	</p>
	
	<p class="form-field" style="display: block;">
		<label for="_shipping_fee_national_disable"><?php _e( 'Disable national shipping', 'wcvendors-pro' ); ?></label>
		<input type="checkbox" class="checkbox" style="" name="_shipping_fee_national_disable" id="_shipping_fee_national_disable" <?php checked( 'yes', $shipping_details[ 'national_disable' ], true ); ?> />
	</p>
...
<div class="options_group">
	...
	<p><strong><?php _e( 'International Rates', 'wcvendors-pro' ); ?></p>
	<p class="form-field">
	...
	<p class="form-field" style="display: block;">
		...
		<input type="checkbox" class="checkbox" style="" name="_shipping_fee_international_qty" id="_shipping_fee_international_qty" <?php checked( 'yes', $shipping_details[ 'international_qty_override' ], true ); ?> />
	...
	<p class="form-field" style="display: block;">
		...
		<input type="checkbox" class="checkbox" style="" name="_shipping_fee_international_free" id="_shipping_fee_international_free" <?php checked( 'yes', $shipping_details[ 'international_free' ], true ); ?> />
	</p>

	<p class="form-field" style="display: block;">
		<label for="_shipping_fee_international_disable"><?php _e( 'Disable international shipping', 'wcvendors-pro' ); ?></label>
		<input type="checkbox" class="checkbox" style="" name="_shipping_fee_international_disable" id="_shipping_fee_international_disable" <?php checked( 'yes', $shipping_details[ 'international_disable' ], true ); ?> />
	</p>
