						...
						<div class="dropdown-info-acc-wrapper">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
									...
									<li role="presentation" class="divider"></li>
                                    <li role="presentation">
                                        <a role="menuitem" tabindex="-1" href="<?php echo site_url(); ?>/vendor_dashboard" class="display-name">
                                            <i class="fa fa-user"></i><?php _e("Vendor Dashboard", ET_DOMAIN) ?>
                                        </a>
                                    </li>
									<li role="presentation" class="divider"></li>
                                    <li role="presentation">
                                        <a role="menuitem" tabindex="-1" href="<?php echo site_url(); ?>/my-account" class="display-name">
                                            <i class="fa fa-shopping-cart"></i><?php _e("Your Account", ET_DOMAIN) ?>
                                        </a>
                                    </li>
                                    <li role="presentation" class="divider"></li>
                                    <li role="presentation">
