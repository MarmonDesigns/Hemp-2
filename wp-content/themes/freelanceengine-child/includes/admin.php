    ...
    function get_default_options() {
        ...
        return array(
            ...
            'invite_mail_template' => "<p>Hello [display_name],</p>
                                        <p>You have a invitation  from  [blogname] to join a request.</p>
                                        <p>You can view these requests at link : [link]</p>
                                        <p>Sincerely,<br />[blogname]</p>",
            'bid_mail_template' => "<p>Hello [display_name],</p>
                                    <p>You have a new bid on the request : [title].</p>
            ...
            'complete_mail_template' => "<p>Hello [display_name],</p>
                                        <p>You have completed the request  [title].</p>
                                        <p>You can review the request in : [link][review]</p>
                                        <p>Sincerely,<br />[blogname]</p>",
            'bid_accepted_template' => "<p>Hello [display_name],</p>
                                        <p>Your bid on the request [link] has been accepted by [author]</p>
                                        <p>You now can contact the employer for further discussion.</p>
                                        <p>Sincerely,</p>
                                        <p>[blogname]</p>",
            'new_message_mail_template' => "<p>Hello [display_name],</p>
                                            <p>You have a new message on request [title]. Here is the message details:</p>
                                            <p>[message]</p>
            ...
            'ae_receipt_mail'   => '<p>Dear [display_name],</p>
                                    ...
                                    <p>Sincerely,<br />[blogname]</p>'  ,
            'employer_report_mail_template' => '<p>Hello [display_name],</p><p>Request [title] you’ve worked on has a new report.&nbsp;</p><p>You can review the request in : [link]</p><p>Sincerely,</p>',
            'employer_close_mail_template' => '<p>Hello [display_name],</p><p>Request [title] you’ve worked on has been closed by the owner. You should review and send your feedback in 36 hours.&nbsp;</p><p>You can review the request in : [link]</p><p>Sincerely,</p><p>[blogname]</p>',
            'freelancer_report_mail_template' => '<p>Hello [display_name],</p>
                                                <p>Your request has a report from [reporter].</p>
                                                <p>You can review the request in : [link]</p>
                                                <p>Sincerely, </br>
                                                [blogname]</p>',
            'freelancer_quit_mail_template' => '<p>Hello [display_name],</p>
                                                <p>[reporter] has quit your request [title]. You should review and feedback in 36 hours. If you don’t have any feedback, you will lose your fund.</p>
                                                <p>You can review the request in : [link]</p>
                                                <p>Sincerely, </br>
                                                [blogname]</p>',
            'admin_report_mail_template' => '<p>Hello [display_name],</p>
                                            <p>The disputing request [title] has a new report.</p>
                                            <p>You can review the request in : [link]</p>
                                            <p>Sincerely, </br>
                                            [blogname]</p>',
            'fre_refund_mail_template' => '<p>Hello [display_name],</p>
                                            <p>The disputing request [title] has been proceed by admin. </p>
                                            <p>The payment will be transferred back to request’s owner</p>
                                            <p>You can review the request in : [link]</p>
                                            <p>Sincerely, </br>
                                            [blogname]</p>',
    ...
    function admin_setup() {
            ...
            'groups' => array(
                ...
                array(
                    'args' => array(
                        ...
                        'id' => 'pending-post',
                        'class' => 'pending-post',
                        'desc' => __("Set up the limitation for the 'Budget' filter in 'Requests' page.", ET_DOMAIN) ,
                    ) ,
                    'fields' => array(
                        array(
                ...
                array(
                    'args' => array(
                        ...
                        'id' => 'pending-post',
                        'class' => 'pending-post',
                        'desc' => __("Enabling this will make every new request posted pending until you review and approve it manually.", ET_DOMAIN) ,
                    ) ,
                    'fields' => array(
                        array(
                            'id' => 'use_pending',
                ...
                array(
                    'args' => array(
                        ...
                        'desc' => __("Set a maximum number of categories a request can assign to", ET_DOMAIN)
                    ) ,
                    'fields' => array(
                        array(
                            'id' => 'max_cat',
                            'type' => 'text',
                            'title' => __("Max Number Of Request Categories", ET_DOMAIN) ,
                            'name' => 'max_cat',
                            'class' => 'option-item bg-grey-input '
                        )
                    )
                ...
                array(
                    'args' => array(
                        'title' => __("Request Category Order", ET_DOMAIN) ,
                        'id' => 'unit_measurement',
                        'class' => '',
                        'desc' => __("Order list request categories by.", ET_DOMAIN)
                    ) ,
                    ...
                    'fields' => array(
                        array(
                            ...
                            'class' => 'option-item bg-grey-input ',
                            'placeholder' => __("Request Category Order", ET_DOMAIN)
                        )
                    )
                ) ,
                array(
                    'args' => array(
                        'title' => __("Request Type Order", ET_DOMAIN) ,
                        'id' => 'unit_measurement',
                        'class' => '',
                        'desc' => __("Order list request types by.", ET_DOMAIN)
                    ) ,
                    ...
                    'fields' => array(
                        array(
                            ...
                            'class' => 'option-item bg-grey-input ',
                            'placeholder' => __("Request Type Order", ET_DOMAIN)
                        )
                    )
                ) ,
                array(
                    'args' => array(
                        ...
                        'class' => '',
                        'desc' => __("Disable comment on request page.", ET_DOMAIN)
                    ) ,
                ...
                array(
                    'args' => array(
                        ...
                        'id' => 'invited-to-bid',
                        'class' => '',
                        'desc' => __("If you enable this option, freelancers have to be invited first before bidding a request.", ET_DOMAIN)
                    ) ,
        ...
        $sections['url_slug'] = array(
            ...
            'groups' => array(
                array(
                    'args' => array(
                        'title' => __("Request", ET_DOMAIN) ,
                        'id' => 'project-slug',
                        'class' => 'list-package',
                        'desc' => __("Enter slug for your Single Request page", ET_DOMAIN) ,
                    ) ,
                    'fields' => array(
                        array(
                            'id' => 'fre_project_slug',
                            'type' => 'text',
                            'title' => __("Single Request page Slug", ET_DOMAIN) ,
                            'name' => 'fre_project_slug',
                            'placeholder' => __("Single Request page Slug", ET_DOMAIN) ,
                            'class' => 'option-item bg-grey-input ',
                            'default' => 'project'
                        )
                    )
                ...
                array(
                    'args' => array(
                        'title' => __("Request Listing", ET_DOMAIN) ,
                        'id' => 'project-archive_slug',
                        'class' => 'list-package',
                        'desc' => __("Enter slug for your Requests listing page", ET_DOMAIN) ,
                    ) ,
                    'fields' => array(
                        array(
                            'id' => 'fre_project_archive',
                            'type' => 'text',
                            'title' => __("Requests listing page Slug", ET_DOMAIN) ,
                            'name' => 'fre_project_archive',
                            'placeholder' => __("Requests listing page Slug", ET_DOMAIN) ,
                            'class' => 'option-item bg-grey-input ',
                            'default' => 'projects'
                        )
                    )
                ...
                array(
                    'args' => array(
                        'title' => __("Request Category", ET_DOMAIN) ,
                        'id' => 'Project-Category',
                        'class' => 'list-package',
                        'desc' => __("Enter slug for your Request Category page", ET_DOMAIN) ,
                    ) ,
                    'fields' => array(
                        array(
                            'id' => 'project_category_slug',
                            'type' => 'text',
                            'title' => __("Request Category page Slug", ET_DOMAIN) ,
                            'name' => 'project_category_slug',
                            'placeholder' => __("Request Category page Slug", ET_DOMAIN) ,
                            'class' => 'option-item bg-grey-input ',
                ...
                array(
                    'args' => array(
                        'title' => __("Request Type", ET_DOMAIN) ,
                        'id' => 'Project-Type',
                        'class' => 'list-package',
                        'desc' => __("Enter slug for your Request Type page", ET_DOMAIN) ,
                    ) ,
                    'fields' => array(
                        array(
                            'id' => 'project_type_slug',
                            'type' => 'text',
                            'title' => __("Request Type page Slug", ET_DOMAIN) ,
                            'name' => 'project_type_slug',
                            'placeholder' => __("Request Type page Slug", ET_DOMAIN) ,
                            'class' => 'option-item bg-grey-input ',
        ...
        $sections['header_video'] = array(
            ...
            'groups' => array(
                ...
                array(
                    'args' => array(
                        'title' => __("Request Demonstration", ET_DOMAIN) ,
                        'id' => 'header-slider-settings',
                        'class' => '',
                    ...
                    'fields' => array(
                        array(
                            ...
                            'name' => 'home_page',
                            'class' => 'option-item bg-grey-input ',
                            'label' => __('Request demonstration on header video background which can be view by employer', ET_DOMAIN)
                        ) ,
                        array(
                            ...
                            'name' => 'list_project',
                            'class' => 'option-item bg-grey-input ',
                            'label' => __('Request demonstration on header video background which can be view by freelancer', ET_DOMAIN)
                        )
                    )
                ) ,
            ...
            'groups' => array(
                ...
                array(
                    'args' => array(
                        ...
                        'desc' => __("Set payment plans your users can choose when posting new request.", ET_DOMAIN) ,
        ...
        $sections['mailing'] = array(
            ...
            'groups' => array(
                ...
                array(
                    'args' => array(
                        'title' => __("Request Related Mail Template", ET_DOMAIN) ,
                        'id' => 'mail-description-group',
                        'class' => '',
                        'name' => ''
                    ) ,
                    'fields' => array(
                        array(
                            ...
                            'type' => 'desc',
                            'title' => __("Mail description here", ET_DOMAIN) ,
                            'text' => __("Email templates used for request-related event. You can use placeholders to include some specific content", ET_DOMAIN) ,
                            'class' => '',
                            'name' => 'mail_description'
                        )
                    )
                ...
                array(
                    'args' => array(
                        ...
                        'class' => 'payment-gateway',
                        'name' => '',
                        'desc' => __("Send to users when someone invite him join a request", ET_DOMAIN),
                        'toggle' => true
                    ) ,
                    'fields' => array(
                        array(
                ...
                array(
                    'args' => array(
                        ...
                        'class' => 'payment-gateway',
                        'name' => '',
                        'desc' => __("Sent to users when a candidate bid their requests.", ET_DOMAIN),
                        'toggle' => true
                    ) ,
                    'fields' => array(
                        array(
                ...
                array(
                    'args' => array(
                        'title' => __("Complete Request Mail Template", ET_DOMAIN) ,
                        'id' => 'complete-mail',
                        'class' => 'payment-gateway',
                        'name' => '',
                        'desc' => __("Send to user when request he worked on was marked complete.", ET_DOMAIN),
                        'toggle' => true
                    ) ,
                    'fields' => array(
                        array(
                ...
                array(
                    'args' => array(
                        'title' => __("Request Report Mail Template", ET_DOMAIN) ,
                        'id' => 'mail-description-group',
                        'class' => '',
                        'name' => ''
                    ) ,
                    'fields' => array(
                        array(
                            ...
                            'type' => 'desc',
                            'title' => __("Mail description here", ET_DOMAIN) ,
                            'text' => __("Email templates used for request-report event. You can use placeholders to include some specific content", ET_DOMAIN) ,
                            'class' => '',
                            'name' => 'mail_description'
                        )
                    )
                ...
                array(
                    'args' => array(
                        'title' => __("Request was Reported by Employer", ET_DOMAIN) ,
                        'id' => 'employer-report-mail',
                        'class' => 'payment-gateway',
                        'name' => '',
                        'desc' => __("Send to freelancer when employer sends a report on the request.", ET_DOMAIN),
                        'toggle' => true
                    ) ,
                    'fields' => array(
                        array(
                ...
                array(
                    'args' => array(
                        'title' => __("Employer closed the request", ET_DOMAIN) ,
                        'id' => 'employer-close-mail',
                        'class' => 'payment-gateway',
                        'name' => '',
                        'desc' => __("Send to freelancer when employer close request.", ET_DOMAIN),
                        'toggle' => true
                    ) ,
                    'fields' => array(
                        array(
                ...
                array(
                    'args' => array(
                        'title' => __("Request Reported by Freelancer", ET_DOMAIN) ,
                        'id' => 'freelancer-report-mail',
                        'class' => 'payment-gateway',
                        'name' => '',
                        'desc' => __("Send to employer when freelancer send report on request.", ET_DOMAIN),
                        'toggle' => true
                    ) ,
                    'fields' => array(
                        array(
                ...
                array(
                    'args' => array(
                        'title' => __("Freelancer Quit The Request", ET_DOMAIN) ,
                        'id' => 'freelancer-quit-mail',
                        'class' => 'payment-gateway',
                        'name' => '',
                        'desc' => __("Send to the employer when the freelancer quits the request", ET_DOMAIN),
                        'toggle' => true
                    ) ,
                    'fields' => array(
                        array(
                ...
                array(
                    'args' => array(
                        ...
                        'class' => 'payment-gateway',
                        'name' => '',
                        'desc' => __("Send to users when admin refunds the escrow payment to the request's owner.", ET_DOMAIN),
                        'toggle' => true
                    ) ,
                    'fields' => array(
                        array(
