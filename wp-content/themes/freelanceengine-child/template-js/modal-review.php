		...
		<div class="modal-content">
			...
			<?php if($post->post_author == $user_ID) {  // employer finish project form ?>
            	...
            	<label style="line-height:2.5;">
            		...
            		<?php _e( 'You are going to finish this request.' , ET_DOMAIN ); ?><br>
			 ...
			 <?php }else { // freelancer finish project form
			  ...
			  ?>
            	...
            	<label style="line-height:2.5;">
            		<?php _e( 'You are going to finish this request.' , ET_DOMAIN ); ?><br>
					<?php printf(__( '%s has finish request. You will receive payment after you review him.' , ET_DOMAIN ), $employer_name); ?>
				</label>
                <p>
                	<strong class="color-green"><?php echo fre_price_format($bid_budget); ?></strong>
                	<strong class="color-green">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<?php 
				if($status =='complete')
					_e('Rate request and post your review here',ET_DOMAIN); 
				else  
					_e('Complete request and post your review here',ET_DOMAIN);
				?></h4>
			</div>
			<div class="modal-body">
