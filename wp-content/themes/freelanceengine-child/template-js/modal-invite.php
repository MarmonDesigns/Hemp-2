		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">
					...
					<a href="#"><?php echo get_the_author_meta('display_name', $author_id); ?></a> <?php _e('to join your request (choose one or more requests below):', ET_DOMAIN) ?>
				</h4>
			</div>
			<div class="modal-body">
				...
				<?php }else {
					...
					_e("Currently, you do not have any request available to invite this user.", ET_DOMAIN);
					echo ' <a href="'.et_get_page_link('submit-project').'" >'.__("Create a request now", ET_DOMAIN).'</a>';
					echo '</p>';
				} ?>
			</div>
		</div><!-- /.modal-content -->
