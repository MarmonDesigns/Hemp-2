            	...
            	<div class="col-md-12">
                    ...
                    <div class="nav-tabs-profile">
                        ...
                        <ul class="nav nav-tabs responsive" role="tablist" id="myTab">
                            ...
                            <?php if($user_role == 'vendor' || fre_share_role() || $user_role == FREELANCER){ ?>
                            <li>
                            ...
                            <li>
                                <a href="#tab_project_details" role="tab" data-toggle="tab">
                                    <?php _e('Request Details', ET_DOMAIN) ?>
                                </a>
                            </li>
                        </ul>
                    </div>
        	...
        	<div class="row">
                	...
                	<div class="tab-content-profile">
                        ...
                        <div class="tab-content block-profiles responsive">
                                	...
                                	<form class="form-detail-profile-page validateNumVal" id="profile_form">
                                        ...
                                        <div class="form-group">
                                            <div class="skill-profile-control form-group-control">
                                            	<label><?php _e('Types of Products', ET_DOMAIN) ?></label>
                                                <?php 
                                                $switch_skill = ae_get_option('switch_skill');
                                                if(!$switch_skill){
                                                    ?>
                                                    <input class="form-control skill" type="text" id="skill" placeholder="<?php _e("Types of products (max is 5)", ET_DOMAIN); ?>" name="skill"  autocomplete="off" spellcheck="false" >
                                                    ...
                                                    ae_tax_dropdown( 'skill' , array(  'attr' => 'data-chosen-width="100%" data-chosen-disable-search="" multiple data-placeholder="'.__(" Types of products (max is 5)", ET_DOMAIN).'"',
                                                                        'class' => 'sw_skill',
                                                                        'hide_empty' => false, 
                                                                        'hierarchical' => true , 
                                                                        'id' => 'skill' , 
                                            ...
                                            <div class="profile-category">
                                                ...
                                                <?php 
                                                    ae_tax_dropdown( 'project_category' , 
                                                          array(  
                                                                'attr'            => 'data-chosen-width="100%" data-chosen-disable-search="" data-placeholder="'.__("Choose state", ET_DOMAIN).'"',
                                        ...
                                        <div class="form-group portfolios-wrapper"> 
                                        	<div class="form-group-control">
                                                ...
                                                <label><?php _e('Product Showcase', ET_DOMAIN) ?></label>
                            ...
                            <div class="tab-pane fade" id="tab_project_details">
                                ...
                                if($user_role == 'vendor' || fre_share_role() || $user_role == FREELANCER){ ?>
                ...
                <div class="col-md-4">
                	<div class="setting-profile-wrapper <?php echo $user_role; ?>">
                        <?php if($user_role == 'vendor' || $user_role == FREELANCER){ ?>
                    	<div class="form-group">
                            ...
                            <span class="switch-for-hide tooltip-style" data-toggle="tooltip" data-placement="top" 
                                title='<?php _e('Turn on to display an "Invite me" button on your profile, allowing potential employers to suggest requests for you.', ET_DOMAIN);  ?>'
                            >
